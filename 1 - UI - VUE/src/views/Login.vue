...
const handleSubmit = (event: { preventDefault: () => void; }) => {
  ...
  fetch( "https://localhost:7113" + "/Api/Users/CreateTokenIdentity", {
    method: 'POST',
    headers: {
    ...
    <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
      ...
      <form class="mt-4" @submit.prevent="handleSubmit">
        <label class="block">
          ...
          <input v-model="email" type="email" placeholder="E-mail" autocomplete="current-text" required
        ...
        <div class="flex items-center justify-between mt-4">
          <div>
            <label class="inline-flex items-center">
              ...
              <span class="mx-2 text-sm text-gray-600">Mantenha-me conectado</span>
            </label>
          </div>
